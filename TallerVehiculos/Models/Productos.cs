...
namespace TallerVehiculos.Models
{
    ...
    public class Productos
    {
        ...
        [Display(Name = "Image")] public string ImageFullPath => ProductImages == null || ProductImages.Count == 0 ? $"https://localhost:44390/images/noimage.png" : $"https://tallervehiculos20220520150509.azurewebsites.net/productos/{ProductImages}";
